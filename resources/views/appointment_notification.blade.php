                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="fluid-img img-center pb-50"
                                                                                                        ...
                                                                                                        <img src="../images/img_intro_7.png"
                                                                                                            width="282"
                                                                                                            height="300"
                                                                                                            editable="true"
                                                                                                            border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="title-30 a-center pb-10"
                                                                                                        style="font-size:30px; line-height:34px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 10px;">
                                                                                                        <multiline>
                                                                                                            Hi
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="title-36 a-center pb-35"
                                                                                                        style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 35px;">
                                                                                                        <multiline>
                                                                                                            <strong>New
                                                                                                                Message
                                                                                                                From
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="py-30"
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            cellpadding="0">
                                                                                                            <tr>
                                                                                                                <td class="py-35 px-50 mpx-15"
                                                                                                                    style="border-radius: 10px; padding-top: 35px; padding-bottom: 35px; padding-left: 50px; padding-right: 50px;"
                                                                                                                    bgcolor="#f4ecfa">
                                                                                                                    <table
                                                                                                                        width="100%"
                                                                                                                        border="0"
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-18 a-center c-purple pb-15"
                                                                                                                                style="font-size:18px; line-height:22px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; color:#9128df; padding-bottom: 15px;">
                                                                                                                                <multiline>
                                                                                                                                    <strong>@
                                                                                                                                        {{ $patient['email'] }}
                                                                                                                                    </strong>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16 lh-26 a-center c-black"
                                                                                                                                style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; color:#282828;">
                                                                                                                                <multiline>
                                                                                                                                    <em>"ESPECIALIDAD
                                                                                                                                        :
                                                                                                                                        {{ $patient['specialitie_name'] }}"</em>
                                                                                                                                    <br>
                                                                                                                                    <em>"HORA
                                                                                                                                        DE
                                                                                                                                        INICIO
                                                                                                                                        :
                                                                                                                                        {{ $patient['hour_start_format'] }}"</em>
                                                                                                                                    <br>
                                                                                                                                    <em>"HORA
                                                                                                                                        DE
                                                                                                                                        FIN
                                                                                                                                        :
                                                                                                                                        {{ $patient['hour_end_format'] }}"</em>
                                                                                                                                </multiline>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                ...
                                                                                                                <td class="btn-16 c-white l-white"
                                                                                                                    ...
                                                                                                                    <multiline>
                                                                                                                        <a href="#"
                                                                                                                            ...
                                                                                                                            <span
                                                                                                                                class="link c-white"
                                                                                                                                style="text-decoration:none; color:#ffffff;">REPLY
                                                                                                                                NOW</span>
                                                                                                                        </a>
                                                                                                                    </multiline>
                                                                                                                </td>
